    ...
    @foreach($articles as $article)
            <div class="sticky hentry hentry-post blog-big group">
                ...
                <div class="meta group">
                    ...
                    <p class="comments"><span><a href="{{route('articles.show',['alias'=>$article->alias])}}#respond" title="Comment on Section shortcodes &amp; sticky posts!">{{count($article->comments) ? count($article->comments):'0'}} {{\Illuminate\Support\Facades\Lang::Chois('ua.comments',count($article->comments))}}</a></span></p>
                </div>
                <!-- post content -->
