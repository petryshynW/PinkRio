    ...
    <div id="content-home" class="content group">
        <div class="hentry group">
            <div class="section portfolio">
                ...
                <h3 class="title">{{trans('ua.latest_projects')}}</h3>
                        ...
                        <div class="hentry work group portfolio-sticky portfolio-full-description">
                            <div class="work-thumbnail">
                                ...
                                <div class="work-overlay">
                                    ...
                                    <p class="work-overlay-categories"><img src="{{asset(env('THEME'))}}/images/categories.png" alt="Categories" /> in: <a href="category.html">{{$item->filter->title}}</a>, <a href="category.html">Web Design</a></p>
                                </div>
                            </div>
                            <div class="work-description">
                                ...
                                {!! \Illuminate\Support\Str::limit($item->text,200) !!}
...
@else
    <H1>Немає жодної роботи для відображення</H1>
@endif
